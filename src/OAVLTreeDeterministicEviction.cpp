...
OAVLTreeDeterministicEviction::OAVLTreeDeterministicEviction(UntrustedStorageInterface* storage, RandForOramInterface* rand_gen,
...
void OAVLTreeDeterministicEviction::moveToLocal(int leaf, int blockid) {
    bool inOram = false;
...
void OAVLTreeDeterministicEviction::insert(int key, int val) {
    Block to_insert;
...
int OAVLTreeDeterministicEviction::search(int key) {
...
void OAVLTreeDeterministicEviction::evictAfterSearch() {
    while (local.size() > 1)
    {
...
void OAVLTreeDeterministicEviction::evictTwoPaths() {
...
void OAVLTreeDeterministicEviction::evictByLeaf(int leaf) {
...
int OAVLTreeDeterministicEviction::P(int leaf, int level) {
    /*
...
vector<Block> OAVLTreeDeterministicEviction::getStash() {
    return this->stash;
}
    
int OAVLTreeDeterministicEviction::getStashSize() {
    return (int)(this->stash).size();
}
    
int OAVLTreeDeterministicEviction::getNumLeaves() {
    return this->num_leaves;

}

int OAVLTreeDeterministicEviction::getNumLevels() {
    return this->num_levels;

}

int OAVLTreeDeterministicEviction::getNumBlocks() {
    return this->num_blocks;

}

int OAVLTreeDeterministicEviction::getNumBuckets() {
    return this->num_buckets;

}

void OAVLTreeDeterministicEviction::dumpStash() {
...
int OAVLTreeDeterministicEviction::ReverseBits(int g, int bits_length) {
    /*
